...
document.onreadystatechange = function() { 
	...
	// when will jsp page development is started, u must be change index.html to index.jsp
	var checkpage = (currpage).indexOf("index.html"); 
	if(checkpage > 0){
		$('body,html').animate({
			scrollTop: 0
		});
...
$(".slidewrap").hide();
	...
	// var sliderwrapdiv = document.getElementsByClassName('slidewrap');
	// sliderwrapdiv.addEventListener('webkitAnimationEnd',function() { sliderwrapdiv.style.display = 'none'; }, false);
	$(".slidewrap").hide();
	$(".wrap").show();
	if (document.readyState !== "complete") { 
